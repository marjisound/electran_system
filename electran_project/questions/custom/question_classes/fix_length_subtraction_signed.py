...
class Question(BinaryHexBase):
    ...
    def expected_answer(self, value):
        ...
        if value['base'] == 2:
            val1_msb = '{:0>8}'.format(value['random1'])[0]
            val2_msb = '{:0>8}'.format(value['random2'])[0]
            overflow = False
            ...
            val1_msb = '{:0>32}'.format(bin(int(value['random1'], 16))[2:])[0]
            val2_msb = '{:0>32}'.format(bin(int(value['random2'], 16))[2:])[0]
            overflow = False
    ...
    def test_answer(self, student_answer, correct_answer):
        if type(student_answer['answer1']) == str:
            ...
            if 'answer2' not in student_answer:
