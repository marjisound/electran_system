...
class Question(BinaryHexBase):
    ...
    def generate_random(self):
        ...
        random_sector_per_track = random.randrange(370, 580, 10)

        return {'random1': random_rpm, 'random2': random_sector_per_track}

    def expected_answer(self, value):

        result = round((60000 / value['random1']) / value['random2'], 3)
